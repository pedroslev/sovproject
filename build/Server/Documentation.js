...
CREATE TABLE Productos (ID int, Codigo varchar(255), Nombre varchar(255), Descripcion varchar(255), Cantidad int, Categoria varchar(255), Proveedor varchar(255), LinkFoto varchar(255), Costo int, Margen int, Precio int, Mostrar int);
commit;
